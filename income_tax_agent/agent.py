...
from income_tax_agent.ufile.ufile_t3 import get_all_t3, get_t3_info, create_new_t3, remove_t3
from income_tax_agent.ufile.ufile_t3_update import update_t3
from income_tax_agent.ufile.ufile_t5 import get_all_t5, get_t5_info, add_t5, remove_t5
...
root_agent = Agent(
    ...
    tools=[get_all_t5, get_t5_info, get_all_t3, get_t3_info, update_t3, create_new_t3, remove_t3, add_t5, remove_t5],
)
